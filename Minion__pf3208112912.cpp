...
#include "Minion__pf3208112912.h"
...
void UMinion_C__pf3208112912::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
	...
	__Local__5->LayoutData.Offsets.Right = -0.900879f;
	__Local__5->LayoutData.Offsets.Bottom = 0.030029f;
	...
	__Local__7->LayoutData.Offsets.Left = -164.000000f;
	...
	TEXT("Minion"), /* Literal Text */
	TEXT(""), /* Namespace */
	TEXT("7B21382042F49B9A944FAA9BFF6D70AC") /* Key */
	);
	__Local__8->Font.FontObject = CastChecked<UObject>(CastChecked<UDynamicClass>(UMinion_C__pf3208112912::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
	...
	TEXT("Simple Minded entities that patrol the mazes of wonder, dont get too close, For they will try to Rust You"), /* Literal Text */
	TEXT(""), /* Namespace */
	TEXT("DB6A4E334A03F17C3F66C8BDE1D4B271") /* Key */
	);
...
UMinion_C__pf3208112912::UMinion_C__pf3208112912(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
{
	if(HasAnyFlags(RF_ClassDefaultObject) && (UMinion_C__pf3208112912::StaticClass() == GetClass()))
	{
		UMinion_C__pf3208112912::__CustomDynamicClassInitialization(CastChecked<UDynamicClass>(GetClass()));
	}
	
}
void UMinion_C__pf3208112912::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
	Super::PostLoadSubobjects(OuterInstanceGraph);
}
void UMinion_C__pf3208112912::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
struct FRegisterHelper__UMinion_C__pf3208112912
{
	FRegisterHelper__UMinion_C__pf3208112912()
	{
		FConvertedBlueprintsDependencies::Get().RegisterClass(TEXT("/Game/RollingBP/Blueprints/Minion"), &UMinion_C__pf3208112912::__StaticDependenciesAssets);
	}
	static FRegisterHelper__UMinion_C__pf3208112912 Instance;
};
FRegisterHelper__UMinion_C__pf3208112912 FRegisterHelper__UMinion_C__pf3208112912::Instance;
void UMinion_C__pf3208112912::GetSlotNames(TArray<FName>& SlotNames) const
{
	TArray<FName>  __Local__17;
	SlotNames.Append(__Local__17);
}
void UMinion_C__pf3208112912::CustomNativeInitilize()
{
	TArray<UWidgetAnimation*>  __Local__18;
	TArray<FDelegateRuntimeBinding>  __Local__19;
	UWidgetBlueprintGeneratedClass::InitializeWidgetStatic(this, GetClass(), false, false, CastChecked<UWidgetTree>(CastChecked<UDynamicClass>(UMinion_C__pf3208112912::StaticClass())->MiscConvertedSubobjects[0]), __Local__18, __Local__19, nullptr);
}
void UMinion_C__pf3208112912::PreSave()
{
	Super::PreSave();
