...
void ABP_Sky_Sphere_C__pf2298762097::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
	...
	InDynamicClass->UsedAssets.Add(LoadObject<UObject>(nullptr, TEXT("/Engine/EngineSky/SM_SkySphere.SM_SkySphere")));
	InDynamicClass->UsedAssets.Add(LoadObject<UObject>(nullptr, TEXT("/Engine/EngineSky/M_Sky_Panning_Clouds2.M_Sky_Panning_Clouds2")));
	InDynamicClass->UsedAssets.Add(LoadObject<UObject>(nullptr, TEXT("/Engine/EngineSky/C_Sky_Horizon_Color.C_Sky_Horizon_Color")));
	InDynamicClass->UsedAssets.Add(LoadObject<UObject>(nullptr, TEXT("/Engine/EngineSky/C_Sky_Zenith_Color.C_Sky_Zenith_Color")));
	InDynamicClass->UsedAssets.Add(LoadObject<UObject>(nullptr, TEXT("/Engine/EngineSky/C_Sky_Cloud_Color.C_Sky_Cloud_Color")));
}
ABP_Sky_Sphere_C__pf2298762097::ABP_Sky_Sphere_C__pf2298762097(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
{
	...
	bpv__Base__pf->Mobility = EComponentMobility::Static;
	...
	bpv__SkyxSpherexmesh__pfTT->BodyInstance.ResponseToChannels_DEPRECATED.Visibility = ECollisionResponse::ECR_Ignore;
	bpv__SkyxSpherexmesh__pfTT->BodyInstance.ResponseToChannels_DEPRECATED.Camera = ECollisionResponse::ECR_Ignore;
	static TWeakObjectPtr<UProperty> __Local__1{};
	const UProperty* __Local__0 = __Local__1.Get();
	if (nullptr == __Local__0)
	{
		__Local__0 = (FBodyInstance::StaticStruct())->FindPropertyByName(FName(TEXT("CollisionProfileName")));
		check(__Local__0);
		__Local__1 = __Local__0;
	}
	auto& __Local__2 = (*(__Local__0->ContainerPtrToValuePtr<FName >(&(bpv__SkyxSpherexmesh__pfTT->BodyInstance), 0)));
	__Local__2 = FName(TEXT("NoCollision"));
	static TWeakObjectPtr<UProperty> __Local__4{};
	const UProperty* __Local__3 = __Local__4.Get();
	if (nullptr == __Local__3)
	{
		__Local__3 = (FBodyInstance::StaticStruct())->FindPropertyByName(FName(TEXT("CollisionResponses")));
		check(__Local__3);
		__Local__4 = __Local__3;
	}
	auto& __Local__5 = (*(__Local__3->ContainerPtrToValuePtr<FCollisionResponse >(&(bpv__SkyxSpherexmesh__pfTT->BodyInstance), 0)));
	static TWeakObjectPtr<UProperty> __Local__7{};
	const UProperty* __Local__6 = __Local__7.Get();
	if (nullptr == __Local__6)
	{
		__Local__6 = (FCollisionResponse::StaticStruct())->FindPropertyByName(FName(TEXT("ResponseArray")));
		check(__Local__6);
		__Local__7 = __Local__6;
	}
	auto& __Local__8 = (*(__Local__6->ContainerPtrToValuePtr<TArray<FResponseChannel> >(&(__Local__5), 0)));
	...
	__Local__8[0].Channel = FName(TEXT("Visibility"));
	__Local__8[0].Response = ECollisionResponse::ECR_Ignore;
	__Local__8[1].Channel = FName(TEXT("Camera"));
	__Local__8[1].Response = ECollisionResponse::ECR_Ignore;
	...
	{
		__Local__9 = (FBodyInstance::StaticStruct())->FindPropertyByName(FName(TEXT("MassInKgOverride")));
		check(__Local__9);
		__Local__10 = __Local__9;
	}
	auto& __Local__11 = (*(__Local__9->ContainerPtrToValuePtr<float >(&(bpv__SkyxSpherexmesh__pfTT->BodyInstance), 0)));
	__Local__11 = 0.000000f;
	static TWeakObjectPtr<UProperty> __Local__13{};
	const UProperty* __Local__12 = __Local__13.Get();
	if (nullptr == __Local__12)
	{
		__Local__12 = (FBodyInstance::StaticStruct())->FindPropertyByName(FName(TEXT("CollisionEnabled")));
		check(__Local__12);
		__Local__13 = __Local__12;
	}
	auto& __Local__14 = (*(__Local__12->ContainerPtrToValuePtr<TEnumAsByte<ECollisionEnabled::Type> >(&(bpv__SkyxSpherexmesh__pfTT->BodyInstance), 0)));
	__Local__14 = ECollisionEnabled::NoCollision;
	static TWeakObjectPtr<UProperty> __Local__16{};
	const UProperty* __Local__15 = __Local__16.Get();
	if (nullptr == __Local__15)
	{
		__Local__15 = (FBodyInstance::StaticStruct())->FindPropertyByName(FName(TEXT("ObjectType")));
		check(__Local__15);
		__Local__16 = __Local__15;
	}
	auto& __Local__17 = (*(__Local__15->ContainerPtrToValuePtr<TEnumAsByte<ECollisionChannel> >(&(bpv__SkyxSpherexmesh__pfTT->BodyInstance), 0)));
	__Local__17 = ECollisionChannel::ECC_WorldStatic;
	...
	bpv__SkyxSpherexmesh__pfTT->Mobility = EComponentMobility::Static;
	...
	(((UBoolProperty*)__Local__18)->SetPropertyValue_InContainer((bpv__SkyxSpherexmesh__pfTT), false, 0));
...
{
	AssetsToLoad.Add({FName(TEXT("/Engine/EngineSky/SM_SkySphere")), FName(TEXT("SM_SkySphere")), FName(TEXT("/Script/Engine")), FName(TEXT("StaticMesh"))});
	AssetsToLoad.Add({FName(TEXT("/Engine/EngineSky/M_Sky_Panning_Clouds2")), FName(TEXT("M_Sky_Panning_Clouds2")), FName(TEXT("/Script/Engine")), FName(TEXT("Material"))});
	AssetsToLoad.Add({FName(TEXT("/Engine/EngineSky/C_Sky_Horizon_Color")), FName(TEXT("C_Sky_Horizon_Color")), FName(TEXT("/Script/Engine")), FName(TEXT("CurveLinearColor"))});
	AssetsToLoad.Add({FName(TEXT("/Engine/EngineSky/C_Sky_Zenith_Color")), FName(TEXT("C_Sky_Zenith_Color")), FName(TEXT("/Script/Engine")), FName(TEXT("CurveLinearColor"))});
	AssetsToLoad.Add({FName(TEXT("/Engine/EngineSky/C_Sky_Cloud_Color")), FName(TEXT("C_Sky_Cloud_Color")), FName(TEXT("/Script/Engine")), FName(TEXT("CurveLinearColor"))});
}
...
void ABP_Sky_Sphere_C__pf2298762097::bpf__UserConstructionScript__pf()
{
	...
	FLinearColor bpv__CallFunc_GetLinearColorValue_ReturnValue__pf{};
	...
	FRotator bpv__CallFunc_K2_GetActorRotation_ReturnValue__pf{};
	...
	FRotator bpv__CallFunc_K2_GetActorRotation_ReturnValue2__pf{};
	FRotator bpv__CallFunc_MakeRotator_ReturnValue__pf{};
	...
	FVector bpv__CallFunc_Conv_RotatorToVector_ReturnValue__pf{};
	float bpv__CallFunc_MapRangeUnclamped_ReturnValue2__pf{};
	FLinearColor bpv__CallFunc_Conv_VectorToLinearColor_ReturnValue__pf{};
	FLinearColor bpv__CallFunc_GetLinearColorValue_ReturnValue2__pf{};
	FLinearColor bpv__CallFunc_GetLinearColorValue_ReturnValue3__pf{};
	float bpv__CallFunc_Add_FloatFloat_ReturnValue__pf{};
	float bpv__CallFunc_FClamp_ReturnValue__pf{};
	FLinearColor bpv__CallFunc_LinearColorLerp_ReturnValue__pf{};
	FLinearColor bpv__CallFunc_Conv_ColorToLinearColor_ReturnValue__pf{};
	bool bpv__CallFunc_IsValid_ReturnValue__pf{};
	FRotator bpv__CallFunc_K2_GetActorRotation_ReturnValue3__pf{};
	FVector bpv__CallFunc_Conv_RotatorToVector_ReturnValue2__pf{};
	FLinearColor bpv__CallFunc_Conv_VectorToLinearColor_ReturnValue2__pf{};
	...
	do
	{
		...
		case 7:
			{
				FColor __Local__20 = FColor(0,0,0,255);
				bpv__CallFunc_Conv_ColorToLinearColor_ReturnValue__pf = UKismetMathLibrary::Conv_ColorToLinearColor(((IsValid(bpv__Directionalxlightxactor__pfTT) && IsValid(bpv__Directionalxlightxactor__pfTT->LightComponent)) ? (bpv__Directionalxlightxactor__pfTT->LightComponent->LightColor) : (__Local__20)));
				if(IsValid(bpv__Skyxmaterial__pfT))
				{
...
void ABP_Sky_Sphere_C__pf2298762097::bpf__UpdateSunDirection__pf()
{
	...
	FColor __Local__21 = FColor(0,0,0,255);
	bpv__CallFunc_Conv_ColorToLinearColor_ReturnValue__pf = UKismetMathLibrary::Conv_ColorToLinearColor(((IsValid(bpv__Directionalxlightxactor__pfTT) && IsValid(bpv__Directionalxlightxactor__pfTT->LightComponent)) ? (bpv__Directionalxlightxactor__pfTT->LightComponent->LightColor) : (__Local__21)));
	if(IsValid(bpv__Skyxmaterial__pfT))
	{
		bpv__Skyxmaterial__pfT->SetVectorParameterValue(FName(TEXT("Sun color")), bpv__CallFunc_Conv_ColorToLinearColor_ReturnValue__pf);
	}
