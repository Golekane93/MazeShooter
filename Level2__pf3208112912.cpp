...
#include "Level2__pf3208112912.h"
...
void ULevel2_C__pf3208112912::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
	...
	__Local__5->LayoutData.Offsets.Bottom = -3.973999f;
	...
	TEXT("level - 2"), /* Literal Text */
	TEXT(""), /* Namespace */
	TEXT("F78A64C24EB43F90A28B9FA0F5834951") /* Key */
	);
	__Local__8->Font.FontObject = CastChecked<UObject>(CastChecked<UDynamicClass>(ULevel2_C__pf3208112912::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
	...
	TEXT("Having succeeded clearing the first level you now face a deadly adventure with more new enemies. Prepare yourself."), /* Literal Text */
	TEXT(""), /* Namespace */
	TEXT("365D3F974371C8A62D426FA84D5D3D6E") /* Key */
	);
...
ULevel2_C__pf3208112912::ULevel2_C__pf3208112912(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
{
	if(HasAnyFlags(RF_ClassDefaultObject) && (ULevel2_C__pf3208112912::StaticClass() == GetClass()))
	{
		ULevel2_C__pf3208112912::__CustomDynamicClassInitialization(CastChecked<UDynamicClass>(GetClass()));
	}
	
}
void ULevel2_C__pf3208112912::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
	Super::PostLoadSubobjects(OuterInstanceGraph);
}
void ULevel2_C__pf3208112912::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
struct FRegisterHelper__ULevel2_C__pf3208112912
{
	FRegisterHelper__ULevel2_C__pf3208112912()
	{
		FConvertedBlueprintsDependencies::Get().RegisterClass(TEXT("/Game/RollingBP/Blueprints/Level2"), &ULevel2_C__pf3208112912::__StaticDependenciesAssets);
	}
	static FRegisterHelper__ULevel2_C__pf3208112912 Instance;
};
FRegisterHelper__ULevel2_C__pf3208112912 FRegisterHelper__ULevel2_C__pf3208112912::Instance;
void ULevel2_C__pf3208112912::GetSlotNames(TArray<FName>& SlotNames) const
{
	TArray<FName>  __Local__17;
	SlotNames.Append(__Local__17);
}
void ULevel2_C__pf3208112912::CustomNativeInitilize()
{
	TArray<UWidgetAnimation*>  __Local__18;
	TArray<FDelegateRuntimeBinding>  __Local__19;
	UWidgetBlueprintGeneratedClass::InitializeWidgetStatic(this, GetClass(), false, false, CastChecked<UWidgetTree>(CastChecked<UDynamicClass>(ULevel2_C__pf3208112912::StaticClass())->MiscConvertedSubobjects[0]), __Local__18, __Local__19, nullptr);
}
void ULevel2_C__pf3208112912::PreSave()
{
	Super::PreSave();
