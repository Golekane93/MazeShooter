...
#include "GateKeeper2__pf3208112912.h"
...
void UGateKeeper2_C__pf3208112912::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
	...
	__Local__5->LayoutData.Offsets.Right = 2.546875f;
	__Local__5->LayoutData.Offsets.Bottom = -0.414917f;
	...
	TEXT("Alpha Keeper"), /* Literal Text */
	TEXT(""), /* Namespace */
	TEXT("E393034D4CAF15CC36E0698CC44AE72C") /* Key */
	);
	__Local__8->Font.FontObject = CastChecked<UObject>(CastChecked<UDynamicClass>(UGateKeeper2_C__pf3208112912::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
	...
	TEXT("You are trespassing in one of the gate of keepers, Alpha Keeper. None have survived venturing forth. Are you ready to test your mettle"), /* Literal Text */
	TEXT(""), /* Namespace */
	TEXT("14B9017E4471A8B9E01A0D806A5A7660") /* Key */
	);
...
UGateKeeper2_C__pf3208112912::UGateKeeper2_C__pf3208112912(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
{
	if(HasAnyFlags(RF_ClassDefaultObject) && (UGateKeeper2_C__pf3208112912::StaticClass() == GetClass()))
	{
		UGateKeeper2_C__pf3208112912::__CustomDynamicClassInitialization(CastChecked<UDynamicClass>(GetClass()));
	}
	
}
void UGateKeeper2_C__pf3208112912::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
	Super::PostLoadSubobjects(OuterInstanceGraph);
}
void UGateKeeper2_C__pf3208112912::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
struct FRegisterHelper__UGateKeeper2_C__pf3208112912
{
	FRegisterHelper__UGateKeeper2_C__pf3208112912()
	{
		FConvertedBlueprintsDependencies::Get().RegisterClass(TEXT("/Game/RollingBP/Blueprints/GateKeeper2"), &UGateKeeper2_C__pf3208112912::__StaticDependenciesAssets);
	}
	static FRegisterHelper__UGateKeeper2_C__pf3208112912 Instance;
};
FRegisterHelper__UGateKeeper2_C__pf3208112912 FRegisterHelper__UGateKeeper2_C__pf3208112912::Instance;
void UGateKeeper2_C__pf3208112912::GetSlotNames(TArray<FName>& SlotNames) const
{
	TArray<FName>  __Local__17;
	SlotNames.Append(__Local__17);
}
void UGateKeeper2_C__pf3208112912::CustomNativeInitilize()
{
	TArray<UWidgetAnimation*>  __Local__18;
	TArray<FDelegateRuntimeBinding>  __Local__19;
	UWidgetBlueprintGeneratedClass::InitializeWidgetStatic(this, GetClass(), false, false, CastChecked<UWidgetTree>(CastChecked<UDynamicClass>(UGateKeeper2_C__pf3208112912::StaticClass())->MiscConvertedSubobjects[0]), __Local__18, __Local__19, nullptr);
}
void UGateKeeper2_C__pf3208112912::PreSave()
{
	Super::PreSave();
