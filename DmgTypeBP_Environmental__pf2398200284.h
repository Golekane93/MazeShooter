...
UCLASS(Blueprintable, BlueprintType, meta=(ReplaceConverted="/Engine/EngineDamageTypes/DmgTypeBP_Environmental.DmgTypeBP_Environmental_C", OverrideNativeName="DmgTypeBP_Environmental_C"))
