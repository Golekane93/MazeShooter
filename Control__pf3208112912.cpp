...
#include "Control__pf3208112912.h"
...
void UControl_C__pf3208112912::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
	...
	__Local__4.Reserve(7);
	auto __Local__5 = NewObject<UCanvasPanelSlot>(__Local__1, UCanvasPanelSlot::StaticClass(), TEXT("CanvasPanelSlot_5"));
	__Local__5->LayoutData.Offsets.Right = 2.102051f;
	__Local__5->LayoutData.Offsets.Bottom = 4.034058f;
	...
	__Local__7->LayoutData.Offsets.Left = -204.000000f;
	...
	TEXT("Controls"), /* Literal Text */
	TEXT(""), /* Namespace */
	TEXT("A853F1214BEDA01D9FE0538CC598462D") /* Key */
	);
	__Local__8->Font.FontObject = CastChecked<UObject>(CastChecked<UDynamicClass>(UControl_C__pf3208112912::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
	...
	TEXT("W A S D : For Movement"), /* Literal Text */
	TEXT(""), /* Namespace */
	TEXT("FCF8967E47FD037740A2F69CE33DC250") /* Key */
	);
	...
	auto __Local__17 = NewObject<UCanvasPanelSlot>(__Local__1, UCanvasPanelSlot::StaticClass(), TEXT("CanvasPanelSlot_0"));
	__Local__17->LayoutData.Offsets.Left = -392.960938f;
	__Local__17->LayoutData.Offsets.Top = -32.540527f;
	...
	auto __Local__18 = NewObject<UTextBlock>(__Local__0, UTextBlock::StaticClass(), TEXT("TextBlock_0"));
	__Local__18->Text = FInternationalization::ForUseOnlyByLocMacroAndGraphNodeTextLiterals_CreateText(
	TEXT("Space / Mouse Button 1 : Jump"), /* Literal Text */
	TEXT(""), /* Namespace */
	TEXT("22A4B2CB4A3DBC3A9F11EDA510484E6A") /* Key */
	);
	__Local__18->Font.Size = 40;
	__Local__18->Slot = __Local__17;
	__Local__17->Content = __Local__18;
	__Local__4.Add(__Local__17);
	auto __Local__19 = NewObject<UCanvasPanelSlot>(__Local__1, UCanvasPanelSlot::StaticClass(), TEXT("CanvasPanelSlot_3"));
	__Local__19->LayoutData.Offsets.Left = -396.960938f;
	__Local__19->LayoutData.Offsets.Top = 67.459473f;
	...
	auto __Local__20 = NewObject<UTextBlock>(__Local__0, UTextBlock::StaticClass(), TEXT("TextBlock_3"));
	__Local__20->Text = FInternationalization::ForUseOnlyByLocMacroAndGraphNodeTextLiterals_CreateText(
	TEXT("Mouse Button 2 : Fire Projectiles"), /* Literal Text */
	TEXT(""), /* Namespace */
	TEXT("1994852241732028641685B6E85F714A") /* Key */
	);
	__Local__20->Font.Size = 40;
	__Local__20->Slot = __Local__19;
	__Local__19->Content = __Local__20;
	__Local__4.Add(__Local__19);
	auto __Local__21 = NewObject<UCanvasPanelSlot>(__Local__1, UCanvasPanelSlot::StaticClass(), TEXT("CanvasPanelSlot_4"));
	__Local__21->LayoutData.Offsets.Left = -644.000000f;
	__Local__21->LayoutData.Offsets.Top = 248.000000f;
	...
	auto __Local__22 = NewObject<UTextBlock>(__Local__0, UTextBlock::StaticClass(), TEXT("TextBlock_4"));
	__Local__22->Text = FInternationalization::ForUseOnlyByLocMacroAndGraphNodeTextLiterals_CreateText(
	TEXT("Try to clear the Maze as fast as you can, Becareful though every input depletes energy."), /* Literal Text */
	TEXT(""), /* Namespace */
	TEXT("59D249FC40D94827FB0CC793BFCAA125") /* Key */
	);
	static TWeakObjectPtr<UProperty> __Local__24{};
	const UProperty* __Local__23 = __Local__24.Get();
	if (nullptr == __Local__23)
	{
		__Local__23 = (FSlateColor::StaticStruct())->FindPropertyByName(FName(TEXT("SpecifiedColor")));
		check(__Local__23);
		__Local__24 = __Local__23;
	}
	auto& __Local__25 = (*(__Local__23->ContainerPtrToValuePtr<FLinearColor >(&(__Local__22->ColorAndOpacity), 0)));
	__Local__25 = FLinearColor(1.000000, 0.000000, 0.000000, 1.000000);
	...
	TEXT("P - Pause"), /* Literal Text */
	TEXT(""), /* Namespace */
	TEXT("B9682AB44FFF9DC3BA178283EBE81427") /* Key */
	);
	__Local__27->Font.Size = 40;
	__Local__27->Slot = __Local__26;
	__Local__26->Content = __Local__27;
	__Local__4.Add(__Local__26);
	__Local__0->RootWidget = __Local__1;
}
UControl_C__pf3208112912::UControl_C__pf3208112912(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
{
	if(HasAnyFlags(RF_ClassDefaultObject) && (UControl_C__pf3208112912::StaticClass() == GetClass()))
	{
		UControl_C__pf3208112912::__CustomDynamicClassInitialization(CastChecked<UDynamicClass>(GetClass()));
	}
	
}
void UControl_C__pf3208112912::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
	Super::PostLoadSubobjects(OuterInstanceGraph);
}
void UControl_C__pf3208112912::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
struct FRegisterHelper__UControl_C__pf3208112912
{
	FRegisterHelper__UControl_C__pf3208112912()
	{
		FConvertedBlueprintsDependencies::Get().RegisterClass(TEXT("/Game/RollingBP/Blueprints/Control"), &UControl_C__pf3208112912::__StaticDependenciesAssets);
	}
	static FRegisterHelper__UControl_C__pf3208112912 Instance;
};
FRegisterHelper__UControl_C__pf3208112912 FRegisterHelper__UControl_C__pf3208112912::Instance;
void UControl_C__pf3208112912::GetSlotNames(TArray<FName>& SlotNames) const
{
	TArray<FName>  __Local__28;
	SlotNames.Append(__Local__28);
}
void UControl_C__pf3208112912::CustomNativeInitilize()
{
	TArray<UWidgetAnimation*>  __Local__29;
	TArray<FDelegateRuntimeBinding>  __Local__30;
	UWidgetBlueprintGeneratedClass::InitializeWidgetStatic(this, GetClass(), false, false, CastChecked<UWidgetTree>(CastChecked<UDynamicClass>(UControl_C__pf3208112912::StaticClass())->MiscConvertedSubobjects[0]), __Local__29, __Local__30, nullptr);
}
void UControl_C__pf3208112912::PreSave()
{
	Super::PreSave();
