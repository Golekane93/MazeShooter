...
#include "EnergyBalls__pf3208112912.h"
...
void UEnergyBalls_C__pf3208112912::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
	...
	__Local__7->LayoutData.Offsets.Left = -304.960938f;
	__Local__7->LayoutData.Offsets.Top = -308.540527f;
	...
	TEXT("Energy Balls"), /* Literal Text */
	TEXT(""), /* Namespace */
	TEXT("6F2F06264CA044CD756868BA4F67EAD6") /* Key */
	);
	__Local__8->Font.FontObject = CastChecked<UObject>(CastChecked<UDynamicClass>(UEnergyBalls_C__pf3208112912::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
	...
	TEXT("When you have used up to much energy look for these energy ball to recover some energy back. \"You cant explore on empty tank you know\""), /* Literal Text */
	TEXT(""), /* Namespace */
	TEXT("9B5EB2AE4E3E7A5FD3A967B72C1FDBEF") /* Key */
	);
...
UEnergyBalls_C__pf3208112912::UEnergyBalls_C__pf3208112912(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
{
	if(HasAnyFlags(RF_ClassDefaultObject) && (UEnergyBalls_C__pf3208112912::StaticClass() == GetClass()))
	{
		UEnergyBalls_C__pf3208112912::__CustomDynamicClassInitialization(CastChecked<UDynamicClass>(GetClass()));
	}
	
}
void UEnergyBalls_C__pf3208112912::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
	Super::PostLoadSubobjects(OuterInstanceGraph);
}
void UEnergyBalls_C__pf3208112912::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
struct FRegisterHelper__UEnergyBalls_C__pf3208112912
{
	FRegisterHelper__UEnergyBalls_C__pf3208112912()
	{
		FConvertedBlueprintsDependencies::Get().RegisterClass(TEXT("/Game/RollingBP/Blueprints/EnergyBalls"), &UEnergyBalls_C__pf3208112912::__StaticDependenciesAssets);
	}
	static FRegisterHelper__UEnergyBalls_C__pf3208112912 Instance;
};
FRegisterHelper__UEnergyBalls_C__pf3208112912 FRegisterHelper__UEnergyBalls_C__pf3208112912::Instance;
void UEnergyBalls_C__pf3208112912::GetSlotNames(TArray<FName>& SlotNames) const
{
	TArray<FName>  __Local__17;
	SlotNames.Append(__Local__17);
}
void UEnergyBalls_C__pf3208112912::CustomNativeInitilize()
{
	TArray<UWidgetAnimation*>  __Local__18;
	TArray<FDelegateRuntimeBinding>  __Local__19;
	UWidgetBlueprintGeneratedClass::InitializeWidgetStatic(this, GetClass(), false, false, CastChecked<UWidgetTree>(CastChecked<UDynamicClass>(UEnergyBalls_C__pf3208112912::StaticClass())->MiscConvertedSubobjects[0]), __Local__18, __Local__19, nullptr);
}
void UEnergyBalls_C__pf3208112912::PreSave()
{
	Super::PreSave();
