...
void AEnemyProjectile_C__pf3208112912::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
...
AEnemyProjectile_C__pf3208112912::AEnemyProjectile_C__pf3208112912(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
{
	if(HasAnyFlags(RF_ClassDefaultObject) && (AEnemyProjectile_C__pf3208112912::StaticClass() == GetClass()))
	{
		AEnemyProjectile_C__pf3208112912::__CustomDynamicClassInitialization(CastChecked<UDynamicClass>(GetClass()));
	}
	...
	__Local__12[0].Channel = FName(TEXT("Pawn"));
	__Local__12[0].Response = ECollisionResponse::ECR_Ignore;
	...
	{
		__Local__21 = (FBodyInstance::StaticStruct())->FindPropertyByName(FName(TEXT("ObjectType")));
		check(__Local__21);
		__Local__22 = __Local__21;
	}
	auto& __Local__23 = (*(__Local__21->ContainerPtrToValuePtr<TEnumAsByte<ECollisionChannel> >(&(bpv__CollisionComponent__pf->BodyInstance), 0)));
	__Local__23 = ECollisionChannel::ECC_GameTraceChannel1;
	...
	bpv__Sphere__pf->StaticMesh = CastChecked<UStaticMesh>(CastChecked<UDynamicClass>(AEnemyProjectile_C__pf3208112912::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
	bpv__Sphere__pf->OverrideMaterials = TArray<UMaterialInterface*> ();
	bpv__Sphere__pf->OverrideMaterials.Reserve(1);
	bpv__Sphere__pf->OverrideMaterials.Add(CastChecked<UMaterialInterface>(CastChecked<UDynamicClass>(AEnemyProjectile_C__pf3208112912::StaticClass())->UsedAssets[1], ECastCheckedType::NullAllowed));
	...
	auto& __Local__24 = (*(__Local__4->ContainerPtrToValuePtr<FName >(&(bpv__Sphere__pf->BodyInstance), 0)));
	__Local__24 = FName(TEXT("NoCollision"));
	auto& __Local__25 = (*(__Local__7->ContainerPtrToValuePtr<FCollisionResponse >(&(bpv__Sphere__pf->BodyInstance), 0)));
	auto& __Local__26 = (*(__Local__10->ContainerPtrToValuePtr<TArray<FResponseChannel> >(&(__Local__25), 0)));
	__Local__26 = TArray<FResponseChannel> ();
	__Local__26.AddUninitialized(2);
	FResponseChannel::StaticStruct()->InitializeStruct(__Local__26.GetData(), 2);
	__Local__26[0].Channel = FName(TEXT("Visibility"));
	__Local__26[0].Response = ECollisionResponse::ECR_Ignore;
	__Local__26[1].Channel = FName(TEXT("Camera"));
	__Local__26[1].Response = ECollisionResponse::ECR_Ignore;
	bpv__Sphere__pf->BodyInstance.bAutoWeld = false;
	auto& __Local__27 = (*(__Local__15->ContainerPtrToValuePtr<float >(&(bpv__Sphere__pf->BodyInstance), 0)));
	__Local__27 = 1499.092041f;
	static TWeakObjectPtr<UProperty> __Local__29{};
	const UProperty* __Local__28 = __Local__29.Get();
	if (nullptr == __Local__28)
	{
		__Local__28 = (FBodyInstance::StaticStruct())->FindPropertyByName(FName(TEXT("CollisionEnabled")));
		check(__Local__28);
		__Local__29 = __Local__28;
	}
	auto& __Local__30 = (*(__Local__28->ContainerPtrToValuePtr<TEnumAsByte<ECollisionEnabled::Type> >(&(bpv__Sphere__pf->BodyInstance), 0)));
	__Local__30 = ECollisionEnabled::NoCollision;
	auto& __Local__31 = (*(__Local__21->ContainerPtrToValuePtr<TEnumAsByte<ECollisionChannel> >(&(bpv__Sphere__pf->BodyInstance), 0)));
	...
	bpv__Projectile__pf->InitialSpeed = 10000.000000f;
	bpv__Projectile__pf->MaxSpeed = 10000.000000f;
...
void AEnemyProjectile_C__pf3208112912::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
...
void AEnemyProjectile_C__pf3208112912::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
struct FRegisterHelper__AEnemyProjectile_C__pf3208112912
{
	FRegisterHelper__AEnemyProjectile_C__pf3208112912()
	{
		FConvertedBlueprintsDependencies::Get().RegisterClass(TEXT("/Game/RollingBP/Blueprints/EnemyProjectile"), &AEnemyProjectile_C__pf3208112912::__StaticDependenciesAssets);
	}
	static FRegisterHelper__AEnemyProjectile_C__pf3208112912 Instance;
};
FRegisterHelper__AEnemyProjectile_C__pf3208112912 FRegisterHelper__AEnemyProjectile_C__pf3208112912::Instance;
void AEnemyProjectile_C__pf3208112912::bpf__ExecuteUbergraph_EnemyProjectile__pf_0(int32 bpp__EntryPoint__pf)
{
	...
	b0l__K2Node_DynamicCast_AsPhysics_Ball_BP__pf = Cast<APhysicsBallBP_C__pf3208112912>(b0l__CallFunc_GetOwner_ReturnValue__pf);
	...
	// optimized KCST_UnconditionalGoto
	float __Local__32 = 0.000000;
	b0l__CallFunc_Subtract_FloatFloat_ReturnValue__pf = UKismetMathLibrary::Subtract_FloatFloat(((IsValid(b0l__K2Node_DynamicCast_AsPhysics_Ball_BP__pf)) ? (b0l__K2Node_DynamicCast_AsPhysics_Ball_BP__pf->bpv__Energy__pf) : (__Local__32)), 5.000000);
	if(IsValid(b0l__K2Node_DynamicCast_AsPhysics_Ball_BP__pf))
	{
		b0l__K2Node_DynamicCast_AsPhysics_Ball_BP__pf->bpv__Energy__pf = b0l__CallFunc_Subtract_FloatFloat_ReturnValue__pf;
	}
	b0l__CallFunc_K2_GetActorLocation_ReturnValue__pf = K2_GetActorLocation();
	UGameplayStatics::PlaySoundAtLocation(this, CastChecked<USoundBase>(CastChecked<UDynamicClass>(AEnemyProjectile_C__pf3208112912::StaticClass())->UsedAssets[16], ECastCheckedType::NullAllowed), b0l__CallFunc_K2_GetActorLocation_ReturnValue__pf, FRotator(0.000000,0.000000,0.000000), 1.000000, 1.000000, 0.000000, nullptr, nullptr);
	b0l__CallFunc_K2_GetActorLocation_ReturnValue__pf = K2_GetActorLocation();
	b0l__CallFunc_SpawnEmitterAtLocation_ReturnValue__pf = UGameplayStatics::SpawnEmitterAtLocation(this, CastChecked<UParticleSystem>(CastChecked<UDynamicClass>(AEnemyProjectile_C__pf3208112912::StaticClass())->UsedAssets[15], ECastCheckedType::NullAllowed), b0l__CallFunc_K2_GetActorLocation_ReturnValue__pf, FRotator(0.000000,0.000000,0.000000), true);
	b0l__CallFunc_K2_GetActorLocation_ReturnValue__pf = K2_GetActorLocation();
	UGameplayStatics::PlayWorldCameraShake(this, UCharCamShake_C__pf895046141::StaticClass(), b0l__CallFunc_K2_GetActorLocation_ReturnValue__pf, 0.000000, 0.000000, 1.000000, true);
	K2_DestroyActor();
	return; // KCST_GotoReturn
}
void AEnemyProjectile_C__pf3208112912::bpf__ExecuteUbergraph_EnemyProjectile__pf_1(int32 bpp__EntryPoint__pf)
{
	...
	if(IsValid(b0l__K2Node_Event_OtherComp__pf))
	{
		b0l__K2Node_Event_OtherComp__pf->AddImpulseAtLocation(b0l__CallFunc_Multiply_VectorFloat_ReturnValue__pf, b0l__CallFunc_K2_GetActorLocation_ReturnValue2__pf, FName(TEXT("None")));
	}
	b0l__CallFunc_K2_GetActorLocation_ReturnValue2__pf = K2_GetActorLocation();
	UGameplayStatics::PlaySoundAtLocation(this, CastChecked<USoundBase>(CastChecked<UDynamicClass>(AEnemyProjectile_C__pf3208112912::StaticClass())->UsedAssets[16], ECastCheckedType::NullAllowed), b0l__CallFunc_K2_GetActorLocation_ReturnValue2__pf, FRotator(0.000000,0.000000,0.000000), 1.000000, 1.000000, 0.000000, nullptr, nullptr);
	b0l__CallFunc_K2_GetActorLocation_ReturnValue2__pf = K2_GetActorLocation();
	b0l__CallFunc_SpawnEmitterAtLocation_ReturnValue2__pf = UGameplayStatics::SpawnEmitterAtLocation(this, CastChecked<UParticleSystem>(CastChecked<UDynamicClass>(AEnemyProjectile_C__pf3208112912::StaticClass())->UsedAssets[15], ECastCheckedType::NullAllowed), b0l__CallFunc_K2_GetActorLocation_ReturnValue2__pf, FRotator(0.000000,0.000000,0.000000), true);
	K2_DestroyActor();
	return; // KCST_GotoReturn
}
void AEnemyProjectile_C__pf3208112912::bpf__BndEvt__Projectile_K2Node_ComponentBoundEvent_0_OnProjectileBounceDelegate__DelegateSignature__pf(/*out*/ FHitResult const& bpp__ImpactResult__pf, /*out*/ FVector const& bpp__ImpactVelocity__pf)
{
	...
	bpf__ExecuteUbergraph_EnemyProjectile__pf_0(12);
}
void AEnemyProjectile_C__pf3208112912::bpf__ReceiveHit__pf(UPrimitiveComponent* bpp__MyComp__pf, AActor* bpp__Other__pf, UPrimitiveComponent* bpp__OtherComp__pf, bool bpp__bSelfMoved__pf, FVector bpp__HitLocation__pf, FVector bpp__HitNormal__pf, FVector bpp__NormalImpulse__pf, /*out*/ FHitResult const& bpp__Hit__pf)
{
	...
	bpf__ExecuteUbergraph_EnemyProjectile__pf_1(13);
}
void AEnemyProjectile_C__pf3208112912::bpf__UserConstructionScript__pf()
{
}
